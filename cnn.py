...
# FILENAME: cnn.py
# SPECIFICATION: uild and train a Convolutional Neural Network (CNN) using TensorFlow and Keras to classify 32x32 images of handwritten digits
